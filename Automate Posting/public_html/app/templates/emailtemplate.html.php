...
<body>
	<div class="email">
		<header>
			...
			<p class="intro">I have just published a new article on my tech blog.</p> <br />
		</header>
		<div class="content">
			<div class="img-container">
				<img src="cid:featuredImage" title="<?php echo $imageTitle;?>"/>
			</div>
			...
			<p>Read more here >> <a id="readmore" href="<?php echo $readMoreLink;?>" title="Read more"><?php echo $readMoreText;?></a></p>
