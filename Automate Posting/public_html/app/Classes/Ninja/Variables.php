...
namespace Ninja
{
	class Variables
	{
		public const SITENAME = '<span class="logo-style">THELINUX</span><span class="logo-style-two">POST<small>.com</small></span>';
        // public const SITENAME = '<span class="logo-style">L</span>';
		public const TITLE = 'TheLinuxPost';
