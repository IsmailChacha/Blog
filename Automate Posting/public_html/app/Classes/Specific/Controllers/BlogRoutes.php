...
namespace Specific\Controllers
{
	...
	class BlogRoutes implements \Ninja\Routes
	{
		...
		private $mailingListTable; //MAILING LIST DB TABLE
		...
		{
			require ROOT_PATH . '/app/includes/DatabaseConnection.php';

			$this->postsTable = new \Ninja\DatabaseHandler($pdo, 'Articles', 'Id', 'AuthorId', '\Specific\Entity\Post', [&$this->usersTable, &$this->postTopics, &$this->postsTable, &$this->topicsTable, &$this->mailingListTable]);
